		...
		<div class="col-lg-15">
			<div class="page-content">
				<div class="starhead">
					...
					<div class="write">
						<a href="/starspot?sortField=id">최신순</a> <a href="/starspot?sortField=views">조회순</a> |
				...
				<div class="paging">
					<c:if test="${pagination.hasPreviousBlock}">
						<a href="?page=0&sortField=${sortField}">
					...
					<c:if test="${pagination.hasNextBlock}">
						...
						&nbsp;
			            <a href="?page=${pagination.totalPages - 1}&sortField=${sortField}">
